...
internal static class MenuFactory
{
    internal static Menu GetMenu()
    {
        ...
        MenuOption opt1 = new(1, "1) Add friend", 1, [ConsoleKey.D1, ConsoleKey.NumPad1], () => { });
        MenuOption opt2 = new(2, "2) See all friends", 2, [ConsoleKey.D2, ConsoleKey.NumPad2], () => { });
        MenuOption opt3 = new(3, "3) Search for friends", 3, [ConsoleKey.D3, ConsoleKey.NumPad3], () => { });
